...
- 본동은 가로 50 m × 세로 45 m 직사각형, 그 왼쪽에 10 m × 45 m 부속 구역(용도 미정, 연한 회색)이 붙어 전체 60 m × 45 m.
...
Main building 50 m long × 45 m wide, plus a 10 m × 45 m annex on the west (left) side (light gray, purpose TBD) — 60 × 45 m overall. Three horizontal bands from top: Barn A (20 m), central corridor (5 m, light gray, label "Corridor 5 m – milking holding / cattle passage"), Barn B (20 m).
...
Robot docking/charging shares the tractor bay (red dashed route: west end → corridor → Barn B).
...
- 레이어: WALL, PILLAR, ZONE_REST, ZONE_FEED, ZONE_WATER, CORRIDOR, TRACTOR, MILKER, ANNEX, ROBOT, PATH, DIM, TEXT.
